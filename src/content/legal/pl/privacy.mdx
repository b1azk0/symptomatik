...
Zestawienie wszystkich plików cookie i podobnych technologii używanych w Symptomatik znajduje się w naszej [Polityce cookies](/cookies/).
...
Szczegółowe zestawienie — zawierające nazwy plików cookie, cele, dostawców, czas trwania i kategorie — znajduje się w naszej odrębnej [Polityce cookies](/cookies/). W skrócie: jeden pierwszoosobowy element przechowywania jest bezwzględnie niezbędny (Twoja decyzja dotycząca zgody), skrypt analityczny Cloudflare nie ustawia żadnych plików cookie, a dwa pliki cookie GA4 ładują się wyłącznie po wyrażeniu zgody.
